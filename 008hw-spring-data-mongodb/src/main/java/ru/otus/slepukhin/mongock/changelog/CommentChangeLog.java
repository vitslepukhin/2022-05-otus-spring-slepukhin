...
public class CommentChangeLog {
    @ChangeSet(order = "001", id = "dropCommentsCollection", author = "slepukhin", runAlways = true)
    public void dropComments(MongoDatabase db) {
        db.getCollection(Comment.COLLECTION).drop();
    }
