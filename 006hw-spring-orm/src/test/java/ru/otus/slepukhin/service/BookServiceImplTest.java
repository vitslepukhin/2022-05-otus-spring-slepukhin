...
class BookServiceImplTest {
    ...
    private static final List<Book> EXPECTED_BOOKS_LIST = List.of(
            new Book(1, "Theoretical physics", List.of(new Author(1L, "Pushkin Alexander")), new Genre(1L, "science")),
            new Book(2, "Folk stories",  List.of(new Author(2L, "Smith John")), new Genre(3L, "folk")),
            new Book(3, "Popular chemistry",  List.of(new Author(3L, "Family Name")), new Genre(2L, "popular"))
    );
