...
class BookServiceImplTest {
    ...
    private static final Book EXPECTED_BOOK = new Book(2, "Folk stories", List.of(new Author(2L, "Smith John")), new Genre(3L, "folk"), List.of());
    private static final Book BOOK_FOR_INSERT = new Book(0, "Inserted book", List.of(new Author(2L, "Smith John")), new Genre(2L, "popular"), List.of());
    private static final List<Book> EXPECTED_BOOKS_LIST = List.of(
            new Book(1, "Theoretical physics", List.of(new Author(1L, "Pushkin Alexander")), new Genre(1L, "science"), List.of()),
            new Book(2, "Folk stories",  List.of(new Author(2L, "Smith John")), new Genre(3L, "folk"), List.of()),
            new Book(3, "Popular chemistry",  List.of(new Author(3L, "Family Name")), new Genre(2L, "popular"), List.of())
    );
    ...
    void shouldCorrectInsert() {
        when(mockBookRepository.save(BOOK_FOR_INSERT)).thenReturn(new Book(INSERTED_BOOK_ID, BOOK_FOR_INSERT.getTitle(), BOOK_FOR_INSERT.getAuthors(), BOOK_FOR_INSERT.getGenre(), List.of()));
    ...
    void shouldCorrectUpdate() {
        var updatedBook = new Book(EXISTING_BOOK_ID, "Updated title", List.of(new Author(1L, "Pushkin Alexander")), new Genre(1L, "science"), List.of());
